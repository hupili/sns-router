...
There are so many Social Network Services nowadays.
...
Information spreading in a single domain is a well-developed research topic.
However, cross-domain behavior is a seldom touched area.
Some motivating examples:

\begin{itemize}
	\item 
You subscribe to a blog RSS and read a gossip on it.
The gossip is interesting so you forward it to Renren.
...
Note the roles people play in the above examples. We know Internet routers connect different IP subnet. Analogously, those people are routers across different SNSs. The routing job is done manually at preset. How about making it automated? Can we learn one's forwarding behaviors and ask a robot to do it? 
...
\begin{itemize}
	\item Focus on solving 80\% problems. 
...
\begin{figure}[t!]
	\centering
	\includegraphics[width=0.7\linewidth]{../pic/srfe-screen-1.pdf}
	\caption{Original Home Timeline on SRFE}
\end{figure}

\begin{figure}[t!]
	\centering
	\includegraphics[width=0.7\linewidth]{../pic/srfe-screen-2.pdf}
