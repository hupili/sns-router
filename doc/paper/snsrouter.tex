...
, we disucss design philosophy of SNSAPI \cite{github_snsapi} 
and SNSRouter \cite{github_snsapi}. 
In 
...
\begin{itemize}
	...
	\item Combine human and machine intelligence. 
	\item Stay open with existing services. 
		...
		I won't try hard to enable ``SMS platform'' on SNSAPI. 
